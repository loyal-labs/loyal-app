...
const PAGE_DESCRIPTION =
  "Loyal is an agent wallet on Solana. Every wallet is a Smart Account with policies and spending caps — your AI agents stay within bounds.";
          ...
          },
          {
            ...
            body: (
              <>
                ...
                with that is that a key gives the agent unlimited authority —
