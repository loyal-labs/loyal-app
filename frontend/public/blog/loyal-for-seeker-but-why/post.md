---
title: "Loyal for Seeker - But Why?"
date: "2026-04-24"
hero: hero.jpg
description: "🟥 Who we're building Loyal for and on our vision for decentralized, private agentic finance with human in the loop."
author:
  name: "Rodion, founder"
---
🟥 **Who we're building Loyal for and on our vision for decentralized, private agentic finance with human in the loop.**
...
- You get Telegram handle-based payments in addition to standard wallet addresses, so you can send SPL tokens to a Telegram [@username](https://x.com/@username) instead of trading 44-character strings and hoping your clipboard survived.
...
The Seeker dApp store also skips the bureaucratic red tape of Apple and Google, allowing us to ship faster and iterate with

[@solana](https://x.com/@solana)

power users who actually push products to their limits.
