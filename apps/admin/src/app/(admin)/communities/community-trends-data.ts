...
export type CommunityTrendsData = {
  chartPoints: ActivityTrendChartPoint[];
  totals30d: ActivityTrendTotals;
...
async function loadCommunityTrendsData(): Promise<CommunityTrendsData> {
  ...
  const chartPoints: ActivityTrendChartPoint[] = [];
...
const getCachedCommunityTrendsData = unstable_cache(
  loadCommunityTrendsData,
...
export async function getCommunityTrendsData(): Promise<CommunityTrendsData> {
  return getCachedCommunityTrendsData();
}
