  ...
  return (
    <DialogPrimitive.Root onOpenChange={onOpenChange} open={open}>
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content className="dark fixed top-1/2 left-1/2 z-50 flex h-[420px] w-[calc(100%-2rem)] max-w-[296px] -translate-x-1/2 -translate-y-1/2 flex-col rounded-[24px] bg-[#1d1b20] p-4 font-sans text-[#e1e3e6] outline-none">
          ...
          <div className="mt-auto flex flex-col gap-3">
            ...
            <button
              className={cn(
                "h-11 rounded-full font-medium text-[15px] transition-colors",
                dest
              ...
              type="button"
            >
              {busy ? "Sending…" : dest ? "Withdraw" : "Enter address"}
            </button>
          </div>
