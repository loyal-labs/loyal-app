...
const changedWebTypeScriptFiles = [
  ...
  "src/app/api/smart-accounts/mobile/earn/policy-refunds/prepare/route.ts",
  "src/app/api/smart-accounts/mobile/earn/policy-refunds/scan/route.ts",
  ...
  "src/app/api/smart-accounts/yield-optimization/policy-refunds/prepare/route.ts",
  "src/app/api/smart-accounts/yield-optimization/policy-refunds/scan/route.ts",
...
const requiredRoutes = [
  ...
  "apps/web/src/app/api/smart-accounts/mobile/earn/policy-refunds/prepare/route.ts",
  "apps/web/src/app/api/smart-accounts/mobile/earn/policy-refunds/scan/route.ts",
  ...
  "apps/web/src/app/api/smart-accounts/yield-optimization/policy-refunds/prepare/route.ts",
  "apps/web/src/app/api/smart-accounts/yield-optimization/policy-refunds/scan/route.ts",
