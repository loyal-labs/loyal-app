...
<img
  alt="Private Transactions SDK quick-start flow"
  className="block dark:hidden"
  src="/resources/private-txn/quick-start-light.png"
/>

<img
  alt="Private Transactions SDK quick-start flow"
  className="hidden dark:block"
  src="/resources/private-txn/quick-start-dark.png"
/>
...
const client = await LoyalPrivateTransactionsClient.fromConfig({
  ...
  ephemeralRpcEndpoint: "https://devnet-tee.magicblock.app",
  ephemeralWsEndpoint: "wss://devnet-tee.magicblock.app",
...
Keep the base RPC and PER endpoint on the same network. Use mainnet endpoints only with a mainnet base RPC.
...
The quick start passes when the withdrawal confirms on base Solana and the wallet token balance increases by the expected amount. Inspect the transaction signature before treating the flow as complete.
