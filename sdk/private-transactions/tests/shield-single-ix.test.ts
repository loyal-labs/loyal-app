...
//   ])
// );
// 2s8fh6mjAzQw9UKa5KaowJ2Dq6Tq8KefSt2x7Ts9enYF
const USER_KP = Keypair.fromSecretKey(
  Uint8Array.from([
    206, 209, 109, 241, 151, 67, 225, 149, 253, 37, 161, 216, 150, 38, 33, 158,
    188, 144, 227, 205, 106, 142, 222, 119, 146, 45, 73, 57, 191, 110, 157, 81,
    27, 179, 101, 134, 225, 21, 247, 231, 247, 16, 147, 73, 78, 137, 170, 31,
    151, 36, 153, 190, 153, 127, 17, 21, 247, 5, 218, 151, 13, 10, 102, 112,
  ])
);
