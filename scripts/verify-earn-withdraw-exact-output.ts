const checks = [
  ...
  },
  {
    ...
    command: [
      "bun",
      "test",
      "apps/web/src/lib/yield-optimization/earn-confirm-contracts.test.ts",
      "apps/web/src/lib/yield-optimization/earn-withdraw-confirm.test.ts",
      "--test-name-pattern",
      "\\[earn-withdraw-exact-output\\]",
    ],
    minimumPasses: 2,
  ...
  },
  {
    ...
    command: [
      ...
      "prettier",
      "--check",
      "apps/web/src/lib/yield-optimization/earn-confirm-contracts.shared.ts",
      "apps/web/src/lib/yield-optimization/earn-confirm-contracts.test.ts",
      "apps/web/src/lib/yield-optimization/earn-withdraw-confirm.test.ts",
      "apps/web/src/lib/yield-optimization/earn-withdraw-proof.shared.ts",
